...
export class BlogCommentService {
  ...
  delete(blogCommentId : number) : Observable<number> {
    return this.http.delete<number>(environment.webApi + '/BlogComment/' + blogCommentId.toString());
  }

  getAll(blogId: number) : Observable<BlogComment[]> {
    return this.http.get<BlogComment[]>(environment.webApi + '/BlogComment/' + blogId.toString());
  }
}
